    ...
    <body>
        <div class="container-fluid">
            <div class="row justify-content-center bg-secondary py-3">
                <div class="col-lg-6">
                    <h2 class="text-white text-center mb-0">Manage Product</h2>
                </div>
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="#addProductModal" class="btn btn-success mr-2" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                    <a href="delete?pid=${o.id}" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						
                </div>
            </div>
        </div>
